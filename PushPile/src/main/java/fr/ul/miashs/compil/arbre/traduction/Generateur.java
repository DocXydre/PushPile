...
public class Generateur {
    ...
    private final Tds tds;
    private int labelCount = 0; // Pour générer des labels uniques
    ...
    public String genererExpression(Noeud expr) {
        ...
        if (expr instanceof Idf idf) {
            ...
            if (item.getCategorie().equals(Categorie.LOCAL.getCategorie())) {
                ...
                // Formule Beta : (3 + rang) * -4 pour accéder aux arguments derrière BP
    ...
    public String genererAppel(Appel a) {
        ...
        // Si la fonction retourne quelque chose, il reste sur la pile
        return code.toString();
    }
    ...
    public String genererRetour(Retour r) {
        ...
        // L'emplacement du résultat est juste au-dessus des variables locales
        int offsetRes = (func.getNbVariables() + 2) * 4; 
